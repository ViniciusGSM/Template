...
namespace Template.Application.Tests.Services
{
    public class UserServiceTests
    {
        ...
        {
            var result = userService.Post(new UserViewModel { Name = "Vinicius Mateus", Email = "viniciusmateus@gmail.com" });
            Assert.True(result);
        }
        ...
        public void Get_ValidatingObject()
        {
            ...
            _users.Add(new User { Id = new Guid(), Name = "Vinicius Mateus", Email = "viniciusmateus@gmail.com", DateCreated = DateTime.Now });
        ...
        {
            var exception = Assert.Throws<ValidationException>(() => userService.Post(new UserViewModel { Name = "Vinicius Mateus" }));
